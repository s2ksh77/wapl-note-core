        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.API.post("".concat(baseUrl).concat(prefix, "/app/").concat(channelId, "/chapter/").concat(chapterId, "/page"), dto.response)];
                    case 1:
                        res = _a.sent();
                        if (res.success)
                            return [2 /*return*/, new PageModel(res.response)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_11 = _a.sent();
                        throw Error(JSON.stringify(e_11));
                    case 3: return [2 /*return*/];
                }
            });
        });
...
})(exports.ChapterType || (exports.ChapterType = {}));
...
var ChapterStore = /** @class */ (function () {
    ...
    ChapterStore.prototype.sortChapterList = function (chapters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                normal = chapters.filter(function (chapter) { return chapter.type === exports.ChapterType.NOTEBOOK; });
                shared = chapters.filter(function (chapter) { return chapter.type === exports.ChapterType.SHARED && exports.ChapterType.SHARED_PAGE; });
                recycle = chapters.filter(function (chapter) { return chapter.type === exports.ChapterType.RECYCLE_BIN; });
...
var EditorStore = /** @class */ (function () {
    ...
    EditorStore.prototype.setMarker = function (el) {
        this.marker = new mark(el);
    };
    EditorStore.prototype.mark = function (keyword) {
        var _this = this;
        this.marker.mark(keyword, {
            accuracy: {
                ...
                _this.searchTotalCount = count;
            },
        });
    };
    EditorStore.prototype.unmark = function () {
        this.marker.unmark();
    };
    EditorStore.prototype.setSearchInputValue = function (value) {
        this.searchInputValue = value;
    };
    EditorStore.prototype.endSearching = function () {
        this.searchingKeyword = '';
        this.searchInputValue = '';
        this.searchTotalCount = 0;
        this.unmark();
    };
    EditorStore.prototype.handleSearchEditor = function () {
    ...
    EditorStore.prototype.handleSearchNext = function () {
        if (this.searchTotalCount !== 0) {
