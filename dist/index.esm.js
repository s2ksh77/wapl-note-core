...
var get12HourFormat = function (time, zone) {
    ...
    var timeToMoment = moment.tz(time, zone);
    var today = new Date();
...
var PageStore = /** @class */ (function () {
    ...
    PageStore.prototype.movePage = function (channelId, chapterId, dto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repo.updatePage(channelId, chapterId, Action.MOVE, dto)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
    ...
    PageStore.prototype.editPage = function (channelId, chapterId, dto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repo.updatePage(channelId, chapterId, Action.EDIT_START, dto)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
